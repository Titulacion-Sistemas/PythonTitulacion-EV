...
<html lang="{{ LANGUAGE_CODE|default:"es-ec" }}" {% if LANGUAGE_BIDI %}dir="rtl"{% endif %}>
<head>
  ...
  {% block blockbots %}
    ...
    <link id="favicon" rel="icon" type="image/x-icon" sizes="16x16" href="{% static 'admin/favicon/favicon.ico' %}">
    <link id="favicon2x" rel="icon" type="image/png" sizes="32x32" href="{% static 'admin/favicon/favicon.png' %}">
    <link rel="shortcut icon" type="image/png" href="{% static 'admin/favicon/favicon.png' %}">
</head>
{% load i18n %}
...
{% block footer %}
  ...
  <div id="footer" class="footer">
    <div class="content">
      ...
      <div class="copyright">
        {% block copyright %}
          Potencializado por DjangoSuit<br>
          Copyright &copy; 2013 <a href="http://djangosuit.com" target="_blank">DjangoSuit.com</a>
        {% endblock %}
      </div>
