...
.f12{font-size:12px}
.f14{font-size:14px}
.blue-gradient{background-color:#64BEDB;background-repeat:no-repeat;background-image:-webkit-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));background-image:-webkit-linear-gradient(#64BEDB, #64BEDB);background-image:-moz-linear-gradient(#64BEDB, #64BEDB);background-image:-o-linear-gradient(top, #64BEDB, #64BEDB);background-image:-khtml-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));filter:progid:DXImageTransform.Microsoft.Gradient(StartColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0);-ms-filter:"progid:DXImageTransform.Microsoft.gradient(startColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0))"}
...
@media (max-width:767px){#footer{margin-left:-20px;margin-right:-20px;padding-left:20px;padding-right:20px}}.header{color:#ffffff;height:80px;overflow:hidden;text-shadow:0 -1px #707070;background-color:#64BEDB;background-repeat:no-repeat;background-image:-webkit-gradient(linear, left top, right top, from(#64BEDB), to(#64BEDB));background-image:-webkit-linear-gradient(right center, #64BEDB, #64BEDB);background-image:-moz-linear-gradient(right center, #64BEDB, #64BEDB);background-image:-o-linear-gradient(left, #64BEDB, #64BEDB);background-image:-khtml-gradient(linear, left top, right top, from(#64BEDB), to(#64BEDB));filter:progid:DXImageTransform.Microsoft.Gradient(StartColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=1);-ms-filter:"progid:DXImageTransform.Microsoft.gradient(startColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=1))"}.header .header-content{float:left;height:45px;overflow:hidden;padding:7px 0 0 30px;line-height:normal;overflow:hidden}.header .header-content.header-content-first{border-left:1px solid #64BEDB;margin-top:20px}
...
.header #branding{height:45px;float:left;min-width:200px;border-right:1px solid #64BEDB}.header #branding h1{color:#fff;font-size:18px;margin:20px 15px 0 13px;padding:0;text-shadow:0 -1px #121414}
...
.header #user-tools{padding:12px 20px 0 0;float:right;margin-top: 20px}.header #user-tools .user-links{display:inline-block;margin-left:15px}
...
.footer{color:#666;background-color:#a2d7e9;font-size:11px;line-height:1.5em;text-shadow:0 1px rgba(255,255,255,0.5)}.footer .content{border-top:5px solid #e1e3e5}.footer .content .tools{float:left;padding:15px 0 0 20px}
...
.table tbody>tr.selected>th,.table tbody>tr.selected>td{background-color:#64BEDB;border-top:1px solid #72a8bb;box-shadow:inset 1px 1px 0 rgba(255,255,255,0.2);color:#fff;text-shadow:none}.table tbody>tr.selected>th a,.table tbody>tr.selected>td a{color:#fff;text-decoration:underline}.table tbody>tr.selected>th a:hover,.table tbody>tr.selected>td a:hover{text-decoration:none}
...
.menu-box li.active a{background-color:#64BEDB;background-repeat:no-repeat;background-image:-webkit-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));background-image:-webkit-linear-gradient(#64BEDB, #64BEDB);background-image:-moz-linear-gradient(#64BEDB, #64BEDB);background-image:-o-linear-gradient(top, #64BEDB, #64BEDB);background-image:-khtml-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));filter:progid:DXImageTransform.Microsoft.Gradient(StartColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0);-ms-filter:"progid:DXImageTransform.Microsoft.gradient(startColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0))";color:#fff}
...
.left-nav>ul>li.active>a{color:#fff;text-shadow:0 1px #4f7f92;background-color:#64BEDB;background-repeat:no-repeat;background-image:-webkit-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));background-image:-webkit-linear-gradient(#64BEDB, #64BEDB);background-image:-moz-linear-gradient(#64BEDB, #64BEDB);background-image:-o-linear-gradient(top, #64BEDB, #64BEDB);background-image:-khtml-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));filter:progid:DXImageTransform.Microsoft.Gradient(StartColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0);-ms-filter:"progid:DXImageTransform.Microsoft.gradient(startColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0))";border-bottom-color:#ccc}.left-nav>ul>li.active>a i{background-image:url(../img/glyphicons-halflings-white-shadow.png);opacity:1}
...
.calendar td a:hover,.timelist a:hover{background-color:#64BEDB;background-repeat:no-repeat;background-image:-webkit-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));background-image:-webkit-linear-gradient(#64BEDB, #64BEDB);background-image:-moz-linear-gradient(#64BEDB, #64BEDB);background-image:-o-linear-gradient(top, #64BEDB, #64BEDB);background-image:-khtml-gradient(linear, left top, left bottom, from(#64BEDB), to(#64BEDB));filter:progid:DXImageTransform.Microsoft.Gradient(StartColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0);-ms-filter:"progid:DXImageTransform.Microsoft.gradient(startColorStr='#64BEDB', EndColorStr='#64BEDB', GradientType=0))";text-shadow:0 1px #4f7f92;color:#fff}
.calendar td a:active,.timelist a:active{background:#64BEDB;color:#fff}
